    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "models": {
                ...
                "backtesting_execution": os.getenv("BACKTESTING_EXECUTION_MODEL", "gemini-2.5-flash"),
                "performance_evaluation": os.getenv("PERFORMANCE_EVALUATION_MODEL", "gemini-2.5-pro"),
